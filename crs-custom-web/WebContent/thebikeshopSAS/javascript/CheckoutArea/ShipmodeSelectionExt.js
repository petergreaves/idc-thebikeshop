	...
	*/
	registeredUserContinue: function(billingShippingPageURLForOnline, physicalStoreSelectionURL) {
		...
		if (this.isBOPISEnabled() && this.isPickUpInStore()) {
			...
			var nextLink = 'RESTOrderItemUpdate?remerge=***&check=*n&allocate=***&backorder=***&calculationUsage=-1,-2,-5,-6,-7&calculateOrder=1&orderItemId='+this.orderItemId +'&errorViewName=AjaxOrderItemDisplayView'+'&orderId=.&URL=';
			...
			urlRequestParams["calculationUsage"] = "-1,-2,-5,-6,-7";
	...
	*/
	submitAddressForm:function(formName, stateDivName, hasValidAddresses) {
		...
		*/
		...
		orderItemUpdateParams["calculationUsage"] = "-1,-2,-5,-6,-7";
