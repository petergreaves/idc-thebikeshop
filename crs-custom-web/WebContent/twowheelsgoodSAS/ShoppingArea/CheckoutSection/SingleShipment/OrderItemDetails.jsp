	...
	<c:if test="${orderHasCatentryWithParent}">
		<c:catch var="searchServerException">
			<wcf:rest var="parentCatalogEntrys" url="${searchHostNamePath}${searchContextPath}/store/${WCParam.storeId}/productview/byIds" >
				...
				<wcf:param name="responseFormat" value="json" />
				<wcf:param name="catalogId" value="${sdb.masterCatalog.catalogId}" />
				<wcf:param name="_fields" value="*,catalogEntryView.*,-catalogEntryView.merchandisingAssociations,-catalogEntryView.components,-catalogEntryView.sKUs,-catalogEntryView.attachments,-catalogEntryView.longDescription,-catalogEntryView.parentCatalogGroupID,-catalogEntryView.price,-catalogEntryView.attributes,-catalogEntryView.attributes" />
			</wcf:rest>
		</c:catch>
